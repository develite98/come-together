...
>
	<div class="app-header z-50" bind:this={headerTop}>
		<div class="app-header__top px-4 flex items-center justify-between">
			<svg xmlns="http://www.w3.org/2000/svg" id="Layer_1" viewBox="0 0 540.3 88.7" width="180"
				...
				/><path class="st0" d="M52.8 82.1s-3.6 8-8.7 6.4c-5.1-1.6 1.4-7 1.4-7l7.3.6z" /><path
					class="st0"
				...
				/><path class="st3" d="M60 56.4l30.3 25.1s36.1-48.6-10-61.1L60 56.4z" /><path
					class="st2"
